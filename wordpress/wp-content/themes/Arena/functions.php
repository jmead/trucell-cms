...
$brad_data =  get_option('arena_options'); 
...
function brad_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
            'name'			=> 'Brad Themes Extend', // The plugin name
            'slug'			=> 'brad_themes_extend', // The plugin slug (typically the folder name)
            'source'			=> get_template_directory_uri() . '/framework/plugins/brad_themes_extend.zip', // The plugin source
