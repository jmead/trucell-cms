        ...
        <div class="row-fluid">
          <div class="row-fluid">
            <div class="titlebar-heading">
              <?php if(get_post_meta($brad_page_id, 'brad_page_title', true) != '' ) { echo '<h1><span>'.esc_html(get_post_meta($brad_page_id, 'brad_page_title', true)).'</span></h1>'; } else {  echo '<h1><span>'. $brad_data['blog_title'] .'</span></h1>'; } ?>
            </div>
    ...
    <div class="titlebar-content">
      <div class="container">
        <div class="row-fluid">
          <div class="row-fluid">
            <div class="titlebar-heading">
              <?php if(get_post_meta($brad_page_id, 'brad_page_title', true) != '' ) { echo '<h1><span>'.esc_html(get_post_meta($brad_page_id, 'brad_page_title', true)).'</span></h1>'; } else {  echo '<h1><span>'.get_the_title($brad_page_id).'</span></h1>'; } ?>
              <div class="hr hr-border-<?php echo $brad_data['titlebar_di_color']?> <?php echo $brad_data['titlebar_di_style']?>-border border-<?php echo $brad_data['titlebar_di_width']?>"><span></span></div>
            <?php if(  get_post_meta($brad_page_id,'brad_add_content',true) != ''):
					echo '<div class="titlebar-subcontent">';
					echo esc_html(get_post_meta($brad_page_id,'brad_add_content',true));  
					echo '</div>';
				  endif ; ?>
            </div>
            <?php if( $brad_data['titlebar_breadcrumb'] == 'yes'):
