...
var	$slider_elements = $('#brad_bradslider , #brad_slider_parallax , #brad_slider_height , #brad_slider_nav , #brad_slider_pagination , #brad_ht_responsive , #brad_slider_fullheight , #brad_slider_interval , #brad_slider_swipe , #brad_slider_effect') ,
	$titlebar_elements = $('#brad_page_title , #brad_add_content ,  #brad_titlebar_alignment , #brad_title_height , #brad_titlebar_bg_color , [data-field_id="brad_bg_image_titlebar"]  , #brad_titlebar_bg_cover , #brad_titlebar_bg_repeat , #brad_titlebar_bg_pos , #brad_titlebar_divi, #brad_titlebar_parallax , #brad_titlebar_scheme , #brad_titlebar_bg_opacity , #brad_titlebar_breadcrumb , #brad_titlebar_border , #brad_titlebar_size,#brad_titlebar_valignment,#brad_titlebar_di,#brad_titlebar_di_width,#brad_titlebar_di_color,#brad_titlebar_di_style,#brad_titlebar_bgo_color,#brad_titlebar_bgo_opacity');
