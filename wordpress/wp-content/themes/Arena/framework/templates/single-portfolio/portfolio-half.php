  ...
  <div class="container">
    <div class="row-fluid">
      <div class="row-fluid">
        ...
        <div class="span4">
          <div class="inner-content">
            <h4 class="portfolio-single-heading" style="margin-bottom:30px;"><span><?php echo __('About the Project','brad');?></span></h4>
            ...
            <h4 class="portfolio-single-heading" style="margin-bottom:30px;"><span><?php echo __('Project Info','brad');?></span></h4>
            <div class="project-info">
              ...
              <?php if($brad_data['check_sharebox']): ?>
                  ...
                  <a href="#" onClick="return false;"><?php echo __('Share : ','brad'); ?></a>
                  </h4>
