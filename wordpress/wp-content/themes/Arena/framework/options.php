   ...
   array( "title" => 'Border For Boxed Layout',
	...
	array( "title" => __(  "Background Style for Outer area of boxed content", "brad-framework"),
     ...
     array( "title" => __( "Select a Background Pattern", "brad-framework"),
        ...
        array( "title" => __( "Custom Js", "brad-framework"),
		       "subtitle" => __( "Quickly add some JS to your theme . Do't Included ( <script type=\"text/javascript\"></script> ) Code", "brad-framework"),
		       "id" => "custom_js",
		       "default" => "",
		       "type" => "textarea"
			   ),   		
...
$this->sections[] = array(
        ...
        'fields' => array(
		  ...
		  array( 
			...
			array(  "title" => __( "Main Body  Font", "brad-framework"),
					...
					"text-align" => false ,
					"google" => true ,
					"default" => array('font-type' => false , 'font-family' => 'Open Sans', 'font-style' => '', 'font-weight' => '300' , 'font-size' => '14px' , 'line-height' => '24px'),
					"type" => "typography" ),
		  ...
		  array(  "title" => __( "Secondary Body  Font", "brad-framework"),
					...
					"text-align" => false ,
					"google" => true ,
					"default" => array('font-type' => false , 'font-family' => 'Dosis'),
					"type" => "typography" ),			
            ...
            array(  "title" => __( "H1 - Headline Font", "brad-framework"),
					...
					'letter-spacing' => true ,
					"text-align" => false ,
					"default" => array('font-type' => false  , 'font-family' => 'Dosis', 'font-backup' => 'Arial, Helvetica, sans-serif' , 'font-weight' => '500' , 'font-style' => '', 'font-size' => '39px'  ,  'line-height' => '45px','letter-spacing' => '3px' , "text-transform" => 'uppercase'),
					"type"     => "typography" ),  
			 ...
			 array( "title" => __( "H2 - Headline Font", "brad-framework"),
					...
					"text-transform" => true ,
					"text-align" => false ,
					"default" => array( 'font-type' => false , 'font-family' => 'Dosis', 'font-backup' => 'Arial, Helvetica, sans-serif' , 'font-weight' => '500' , 'font-style' => '', 'font-size' => '30px' , 'line-height' => '40px'  , 'letter-spacing' => '4px' , "text-transform" => 'uppercase'),
					"type" => "typography"),  
             ...
             array( "title" => __( "H3 - Headline Font", "brad-framework"),
					...
					"text-transform" => true ,
					'letter-spacing' => true ,
					"default" => array( 'font-type' => false , 'font-family' => 'Dosis', 'font-backup' => 'Arial, Helvetica, sans-serif' , 'font-weight' => '500' , 'font-style' => '', 'font-size' => '20px' , 'line-height' => '30px'  ,'letter-spacing' => '3px' , "text-transform" => 'uppercase'),
					"type" => "typography"),  
             ...
             array( "title" => __( "H4 - Headline Font", "brad-framework"),
					...
					'letter-spacing' => true ,
					"text-transform" => true ,
					"default" => array( 'font-type' => false , 'font-family' => 'Dosis', 'font-backup' => 'Arial, Helvetica, sans-serif' , 'font-weight' => '500' , 'font-style' => '', 'font-size' => '15px' , 'line-height' => '25px'  , 'letter-spacing' => '2px' , "text-transform" => 'uppercase'),
					"type" => "typography"),  
			...
			array( "title" => __( "H5 - Headline Font", "brad-framework"),
					...
					'letter-spacing' => true ,
					"text-transform" => true ,
					"default" => array( 'font-type' => false , 'font-family' => 'Dosis',"font-backup"=> "Arial, Helvetica, sans-serif" , 'font-weight' => '600' , 'font-style' => '', 'font-size' => '14px' , 'line-height' => '22px'  , 'letter-spacing' => '3px' , "text-transform" => 'uppercase'),
					"type" => "typography"),  
            ...
            array( "title" => __( "H6 - Headline Font", "brad-framework"),
					...
					"text-align" => false ,
					'letter-spacing' => true ,
					"default" => array( 'font-type' => false , 'font-family' => 'Dosis',"font-backup"=> "Arial, Helvetica, sans-serif" , 'font-weight' => '500' , 'font-style' => '', 'font-size' => '14px' , 'line-height' => '24px' , 'letter-spacing' => '2px' , "text-transform" => 'uppercase'),
					"type" => "typography"), 
			...
			array( "title" => __( "Sidebar Headline Font", "brad-framework"),
					...
					'letter-spacing' => true ,
					"text-transform" => true ,
					"default" => array( 'font-type' => false , 'font-family' => 'Dosis', 'font-backup' => 'Arial, Helvetica, sans-serif' , 'font-weight' => '500' , 'font-style' => '', 'font-size' => '14px' , 'line-height' => '45px','letter-spacing' => '2px' , "text-transform" => 'uppercase'),
					"type" => "typography"),
			...
			array(  "title" => __( "Accordion/Toggle & Tabs Font", "brad-framework"),
					...
					"text-align" => false ,
					"google" => true ,
					"default" => array('font-family' => 'Dosis' , 'font-weight' => '500' , 'text-transform' => "uppercase" , 'font-type' => false , "letter-spacing" => "2px" ),
					"type" => "typography" ),	
		...
		array(  "title" => __( "Blockquote Font", "brad-framework"),
					...
					'letter-spacing' => true ,
					"text-align" => false ,
					"default" => array('font-type' => false  , 'font-family' => 'Crete Round', 'font-backup' => 'Arial, Helvetica, sans-serif' , 'font-weight' => 'normal' , 'font-style' => '', "font-style" => "italic" , 'font-size' => '21px' , 'line-height' => '31px','letter-spacing' => '0' , "text-transform" => 'none' , 'color' => '#999999' ),
					"type"     => "typography" )			
		) 	
    );
	...
	'fields' => array(
		 ...
		 array( "title" => __("Second Nav offset", "brad-framework"),
            ...
            array( "type" => "divide",
             ...
             array( "title" => __( "Nav Menu font - first level", "brad-framework"),
					...
					"text-align" => false ,
					"line-height" => false ,
					"default" => array( 'font-type' => false , 'font-family' => 'Open Sans',"font-backup"=> "Arial, Helvetica, sans-serif" , 'font-weight' => '400' ,  'font-style' => '', 'font-size' => '11px' , 'letter-spacing' => '2px' ,"text-transform" => "uppercase"),
					"type"       => "typography"),	
             ...
             array( "title" => __( "Nav Dropdown Menu font", "brad-framework"),
					...
					"text-transform" => true ,
					"line-height" => false ,
					"default" => array( 'font-type' => false , 'font-family' => 'Open Sans',"font-backup"=> "Arial, Helvetica, sans-serif" , 'font-weight' => '400' ,  'font-style' => '', 'font-size' => '10px' , 'letter-spacing' => '1px' , "text-transform" => "uppercase"),
					"type" => "typography"),
			...
			array( "title" => __( "Nav Dropdown Megamenu font", "brad-framework"),
					...
					"text-transform" => true ,
					"line-height" => false ,
					"default" => array( 'font-type' => false , 'font-family' => 'Dosis',"font-backup"=> "Arial, Helvetica, sans-serif" , 'font-weight' => '500' , 'font-style' => '', 'font-size' => '12px' , 'letter-spacing' => '3px' , "text-transform" => "uppercase"),
					"type" => "typography"),
		...
		array(
         ...
         array( "title" => __( "Titlebar Headline Font:Common", "brad-framework"),
				...
				"color" => false ,
				"default" => array('font-type' => false , 'font-family' => 'Dosis',"font-style" => "normal"  ,'font-weight' => '400' ),
				"type" => "typography"), 
	  ...
	  array( "title" => __( "Titlebar Headline Font : Small Size", "brad-framework"),
				...
				"font-style" => false ,
				"font-weight" => false ,
				"default" => array('font-type' => false , "text-transform" => "uppercase"  ,'letter-spacing' => '3px' , 'font-size' => '15px' , 'line-height' => '20px' ),
				"type" => "typography"), 
		...
		array( "title" => __( "Titlebar Headline Medium : Medium Size", "brad-framework"),
				...
				"font-style" => false ,
				"font-weight" => false ,
				"default" => array('font-type' => false , "text-transform" => "uppercase"  ,'letter-spacing' => '5px' , 'font-size' => '32px' , 'line-height' => '42px' ),
				"type" => "typography"), 					
	   ...
	   array( "title" => __( "Titlebar Headline Font : Large Size", "brad-framework"),
				...
				"font-style" => false ,
				"font-weight" => false ,
				"default" => array( 'font-type' => false , "text-transform" => "uppercase"  ,'letter-spacing' => '8px' , 'font-size' => '48px' , 'line-height' => '55px' ),
				"type" => "typography"), 
	     ...
	     array( "title" => __( "Subtitle Font", "brad-framework"),
				...
				"text-transform" => true ,
				"color"  => false , 
				"default" => array(  'font-family' => 'Open Sans' , 'font-type' => false , "font-weight" => '300'  , 'font-style' => '',  "text-transform" => "none"  ,'letter-spacing' => '0' ),
				"type" => "typography")						
		 )
);
	   ...
	   array( "title" => __( "Footer Widget Area1 Text Color", "brad-framework"),
		...
		array( 
		 ...
		 array( "title" => __( "Footer Widget Area1 Headline", "brad-framework"),
					...
					"line-height" => true ,
					'text-transform' => true ,
					"default" => array( 'font-type' => false , 'font-family' => 'Dosis',"font-style" => "normal"  ,'font-weight' => '500', 'font-size' => '14px' , 'font-style' => '','letter-spacing'=> '3px','font-backup' => 'Arial, Helvetica, sans-serif' , 'color' => '#ffffff' , 'text-transform' => 'uppercase' , "line-height" => "35px" ),
					"type" => "typography"),
	   ...
	   array( "title" => __( "Footer Widget Area2 Text Color", "brad-framework"),
		...
		array( 
		 ...
		 array( "title" => __( "Footer Widget Area2 Headline", "brad-framework"),
					...
					"line-height" => true ,
					'text-transform' => true ,
					"default" => array( 'font-type' => false , 'font-family' => 'Dosis',"font-style" => "normal"  ,'font-weight' => '500', 'font-size' => '13px' ,'letter-spacing'=> '1px'  , "line-height" => "35px"  ,'font-backup' => 'Arial, Helvetica, sans-serif' , 'color' => '#ffffff' , 'text-transform' => 'uppercase' ),
					"type" => "typography"),
	...
	array( "title" => __( "Footer Copyright Divider Color", "brad-framework"),
	 ...
	 array( "title" => __( "Footer Copyright Link Color", "brad-framework"),
	  ...
	  array( "title" => __( "Copyright Text", "brad-framework"),
			  ...
			  "default" => "Arena v1.0.1 by <a href='http://themeforest.net/user/bradweb'>bradweb</a>",
			  "type" => "textarea")
			  )
				);
	...
	'fields' => array(
	   ...
	   array(
	    ...
	    array(
                'id' => 'portfolio_item', 
                'type' => 'text', 
                'title' => __('Portfolio Singular Name', "brad-framework"),
                'desc' => ''
			),		
...
$this->sections[] = array(
   ...
   'fields' => array(
             ...
             array( "title" => __( "Brad Slider Title Font", "brad-framework"),
					...
					"text-align" => false ,
					'letter-spacing' => true ,
					"default" => array( 'font-type' => false , 'font-family' => 'Dosis',"font-backup"=> "Arial, Helvetica, sans-serif" , 'font-weight' => '400' , 'font-style' => '', 'font-size' => '48px' ,'line-height' => '60px' , 'letter-spacing' => '10px' , "text-transform" => 'uppercase'),
					"type" => "typography"),	
		     ...
		     array( "title" => __( "Brad Slider SubTitle Font", "brad-framework"),
					...
					"text-align" => false ,
					'letter-spacing' => true ,
					"default" => array( 'font-type' => false , 'font-family' => 'Dosis',"font-backup"=> "Arial, Helvetica, sans-serif" , 'font-weight' => '500' , 'font-style' => '', 'font-size' => '18px' ,  'line-height' => '28px' , 'letter-spacing' => '5px' , "text-transform" => 'uppercase' ),
					"type" => "typography"),				
			 ...
			 array( "title" => __( "Brad Slider Caption Font", "brad-framework"),
					...
					"text-align" => false ,
					'letter-spacing' => true ,
					"default" => array( 'font-type' => false , 'font-family' => 'Open Sans',"font-backup"=> "Arial, Helvetica, sans-serif" , 'font-weight' => '300' , 'font-style' => '','font-size' => '19px',  'line-height' => '30px' , 'letter-spacing' => '0' , "text-transform" => 'none'),
					"type" => "typography"),
...
$this->sections[] = array(
		...
		public function setArguments() {
			...
			$this->args = array(
				...
				'opt_name' => 'arena_options' , // This is where your data is stored in the database and also becomes your global variable name.
				...
				'menu_title'			=> __( 'Arena Options', 'brad-framework' ),
	            'page'		 	 		=> __( 'Arena Options', 'brad-framework' ),
