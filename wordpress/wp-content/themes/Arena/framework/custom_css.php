...
<?php endif; ?>	
  ...
  h6{
   ...
   .toggle .toggle-title, .accordion .accordion-title{
	    font-family: <?php echo $brad_data['font_tabs']['font-family'] ?>;
		font-size: <?php echo $brad_data['font_tabs']['font-size']?>;
		font-style: <?php echo $brad_data['font_tabs']['font-style']?>;
		font-weight: <?php echo $brad_data['font_tabs']['font-weight']?>;
		letter-spacing:<?php echo $brad_data['font_tabs']['letter-spacing'];?>;
		text-transform:<?php echo $brad_data['font_tabs']['text-transform'];?>;
   }
