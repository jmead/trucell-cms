...
vc_add_param( 'vc_row' , array(
	  ...
	  "value" => "40",
	  "param_name" => "sp_left",
	  "dependency" =>  array("element" => "section_type" , "value" => array("full-width-with-padding")),
...
vc_add_param( 'vc_row' , array(
	  "type" => "textfield",
	  "heading" => __("Margin Left","brad-framework"),
	  "value" => "0",
	  "param_name" => "mleft",
	  "description" => "Do't Include px ( in numbers only)"
));
vc_add_param( 'vc_row' , array(
	  "type" => "textfield",
	  "heading" => __("Margin Right","brad-framework"),
	  "value" => "0",
	  "param_name" => "mright",
	  "description" => "Do't Include px ( in numbers only)"
));
...
vc_add_param( 'vc_column' , array(
	"type" => "dropdown",
	"value" => array(
	            __("Default","brad-framework") => "current",
				__("Boxed","brad-framework") => "boxed"
				),
	"heading" => __("Column Type","brad-framework"),
	"param_name" => "ctype",
));
...
vc_map( array(
  ...
  array(
	  "type" => "textfield",
	  "heading" => __("Box Inner Padding top/bottom","brad-framework"),
	  "value" => "40",
	   "dependency" =>  array("element" => "style" , "value" => array("style3")),
	  "param_name" => "ip_top",
	  "description" => "Do't Include px ( in numbers only)"
 ...
 array(
	  "type" => "textfield",
	  "heading" => __("Box Inner Padding left/right","brad-framework"),
	  "value" => "40",
	   "dependency" =>  array("element" => "style" , "value" => array("style3")),
	  "param_name" => "ip_left",
	  "description" => "Do't Include px ( in numbers only)"
...
class WPBakeryShortCode_Vc_Services_Box extends WPBakeryShortCode {
  ...
  array(
        "type" => "textfield",
        "heading" => __("Vertical Padding", "brad-framework"),
        "param_name" => "vpadding",
        "value" => "35px"
	),
 ...
 array(
        "type" => "textfield",
        "heading" => __("Horizental Padding", "brad-framework"),
        "param_name" => "hpadding",
        "value" => "35px"
	),	
...
vc_map( array(
  ...
  array(
      ...
      "param_name" => "br",
      "value" => array( __('Small','brad-framework') => 'small', __('Full','brad-framework') => 'full' ,__('None','brad-framework') => 'no' )
    ),	
