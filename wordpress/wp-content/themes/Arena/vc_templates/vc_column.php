<?php
	...
	$p_right = preg_match('/%/i',$p_right) ||  preg_match('/%/i',$p_right)  ? $p_right : intval($p_right).'px';
     ...
     $css_class = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'section-column bgalignment-'.$ctype.' '.$width.$el_class.$hidden_class, $this->settings['base']);
	   ...
	   if($ctype != 'boxed'){
		   ...
		   $output .= "\n\t".'<div class="'.$css_class.'"><div class="inner-pcontent" style="'.$style.'">';
	   }
